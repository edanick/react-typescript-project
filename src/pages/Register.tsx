        ...
        <Box sx={{
            ...
            <Box component="form" noValidate onSubmit={onSubmitButtonClick} sx={{ mt: 3 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                        <TextField autoComplete="given-name" name="middle" fullWidth id="middle"
                            label="Middle Name" autoFocus value={inputsValue.middle}
                            onChange={onInputChange} />
                        {errorsState?.middle &&
                    ...
                    <Grid item xs={12}>
                        <TextField fullWidth name="url" label="Url" id="url" autoComplete="new-url"
                            value={inputsValue.url} onChange={onInputChange} />
                        {errorsState?.url &&
                            <Alert severity="warning">{errorsState.url}</Alert>}
                    </Grid>

                    <Grid item xs={12}>
                        <TextField fullWidth name="alt" label="Alt" id="alt" autoComplete="new-alt"
                            value={inputsValue.alt} onChange={onInputChange} />
                        {errorsState?.alt &&
                    ...
                    <Grid item xs={12}>
                        <FormControlLabel label="Business Account" control={
                            <Checkbox color="primary" onChange={onCheckboxInputChange} id="isBusiness" />}
                        />
                    </Grid>
