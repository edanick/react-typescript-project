...
export default function CreateCard() {
    const [formData, setFormData] = useState<Card2D>(initialState),

        { title, subtitle, phone, email, description, web, url, alt, state, country,
            city, street, houseNumber, zip } = formData,
    ...
    return (
        <Container sx={{ padding: "50px" }}>
            ...
            <Grid container flexDirection={"column"}>
                ...
                <TextField id="zip" label="Zip" type="number" variant="outlined" sx={{ mt: "10px" }}
